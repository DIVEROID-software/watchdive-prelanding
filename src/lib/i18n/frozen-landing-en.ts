...
export const EN_FROZEN_LANDING_MESSAGES = {
  ...
  faq: {
    ...
    a6: "Watch Dive supports all Apple Watch models and the following Samsung watches: Galaxy Watch4, Galaxy Watch4 Classic, Galaxy Watch5, Galaxy Watch5 Pro, Galaxy Watch6, Galaxy Watch6 Classic, Galaxy Watch FE, Galaxy Watch7, Galaxy Watch Ultra, Galaxy Watch8, Galaxy Watch8 Classic, Galaxy Watch9, and Galaxy Watch Ultra2. Apple Watch Ultra, Apple Watch Ultra 2, Apple Watch Ultra 3, and Galaxy Watch Ultra2 can be used with the Watch Dive app alone; all other supported watches use the Watch Dive sensor housing and app.",
    q7: "How does it work?",
    a7: "The Watch Dive housing has pressure and water-temperature sensors and sends their readings to your smartwatch over Bluetooth.",
    q8: "How long does the battery last, and can it be replaced?",
    a8: "The battery warranty lasts for two years or 1,000 dives, whichever comes first. After that, a Watch Dive-authorized service center can replace a worn battery for a fee.",
  },
  footer: {
    brand: "Watch Dive",
