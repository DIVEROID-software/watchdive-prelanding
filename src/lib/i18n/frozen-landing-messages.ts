 ...
 *   paid-replacement terms — internal draft only, pending the model matrix,
 *   product evidence and an approved written warranty/service policy.
...
const ko: FrozenLandingMessages = {
  ...
  inbox: {
    // 실제 인증 메일의 제목과 버튼은 영어로 발송되므로 인용 부분은 원문 그대로 둔다.
    title: "마지막 한 단계 — 이메일을 인증해 주세요 📬",
    note: "“Confirm your Watch Dive waitlist email” 제목의 메일을 찾아 Confirm my email 버튼을 눌러 주세요. 1분 안에 오지 않으면 스팸함이나 프로모션함을 확인하세요. 링크는 24시간 유효하며 이 페이지는 자동으로 갱신됩니다.",
  ...
  faq: {
    ...
    q6: "제 스마트워치와 호환되나요?",
    a6: "Watch Dive는 모든 Apple Watch 모델과 다음 Samsung 워치를 지원합니다: Galaxy Watch4, Galaxy Watch4 Classic, Galaxy Watch5, Galaxy Watch5 Pro, Galaxy Watch6, Galaxy Watch6 Classic, Galaxy Watch FE, Galaxy Watch7, Galaxy Watch Ultra, Galaxy Watch8, Galaxy Watch8 Classic, Galaxy Watch9, Galaxy Watch Ultra2. Apple Watch Ultra, Apple Watch Ultra 2, Apple Watch Ultra 3, Galaxy Watch Ultra2는 Watch Dive 앱만으로 사용할 수 있으며, 그 외 지원되는 모든 워치는 Watch Dive 센서 하우징과 앱을 함께 사용합니다.",
    q7: "어떻게 작동하나요?",
    a7: "Watch Dive 하우징에는 수압 및 수온 센서가 내장되어 있으며, 측정값을 Bluetooth로 스마트워치에 전송합니다.",
    q8: "배터리는 얼마나 오래가며 교체할 수 있나요?",
    a8: "배터리 보증은 2년 또는 1,000회 다이빙 중 먼저 도래하는 시점까지 유지됩니다. 이후에는 Watch Dive 공인 서비스 센터에서 유상으로 소모된 배터리를 교체할 수 있습니다.",
  },
  footer: {
    brand: "Watch Dive",
    legal:
...
const zhCN: FrozenLandingMessages = {
  ...
  inbox: {
    // 验证邮件的主题与按钮以英文发送，因此引用部分保留原文。
    title: "最后一步 — 请确认你的邮箱 📬",
    note: "请查找主题为“Confirm your Watch Dive waitlist email”的邮件并点击 Confirm my email。一分钟内没收到请检查垃圾邮件或促销邮件文件夹。链接 24 小时内有效，本页会自动更新。",
    noteSubject: "“Confirm your Watch Dive waitlist email”",
    noteButton: "Confirm my email",
    resendIdle: "没收到？重新发送",
    resendWait: "稍后可重新发送",
  ...
  server: {
    ...
    closed: "预启动名单已满。8 月 10 日 Watch Dive 将在 Kickstarter 面向所有人开放。",
  },
  toasts: {
    resent: "已重新发送 — 请查收邮箱。",
    error: "出了点问题，请重试。",
  ...
  faq: {
    ...
    q6: "我的智能手表兼容吗？",
    a6: "Watch Dive 支持所有 Apple Watch 型号以及以下 Samsung 手表：Galaxy Watch4、Galaxy Watch4 Classic、Galaxy Watch5、Galaxy Watch5 Pro、Galaxy Watch6、Galaxy Watch6 Classic、Galaxy Watch FE、Galaxy Watch7、Galaxy Watch Ultra、Galaxy Watch8、Galaxy Watch8 Classic、Galaxy Watch9 和 Galaxy Watch Ultra2。Apple Watch Ultra、Apple Watch Ultra 2、Apple Watch Ultra 3 和 Galaxy Watch Ultra2 仅需 Watch Dive 应用即可使用；其他所有受支持的手表需搭配 Watch Dive 传感器外壳和应用使用。",
    q7: "它是如何工作的？",
    a7: "Watch Dive 外壳内置压力和水温传感器，并通过 Bluetooth 将读数发送到您的智能手表。",
    q8: "电池能用多久？可以更换吗？",
...
const zhTW: FrozenLandingMessages = {
  ...
  inbox: {
    // 驗證信的主旨與按鈕以英文寄送，因此引用部分保留原文。
    title: "最後一步 — 請確認你的信箱 📬",
    note: "請尋找主旨為「Confirm your Watch Dive waitlist email」的郵件並點選 Confirm my email。一分鐘內沒收到請檢查垃圾郵件或促銷信件匣。連結 24 小時內有效，本頁會自動更新。",
    noteSubject: "「Confirm your Watch Dive waitlist email」",
    noteButton: "Confirm my email",
    resendIdle: "沒收到？重新寄送",
    resendWait: "稍後可重新寄送",
  ...
  server: {
    ...
    closed: "預先啟動名單已滿。8 月 10 日 Watch Dive 將在 Kickstarter 對所有人開放。",
  },
  toasts: {
    resent: "已重新寄送 — 請查看收件匣。",
    error: "發生了一點問題，請再試一次。",
  ...
  faq: {
    ...
    q6: "我的智慧手錶相容嗎？",
    a6: "Watch Dive 支援所有 Apple Watch 型號以及下列 Samsung 手錶：Galaxy Watch4、Galaxy Watch4 Classic、Galaxy Watch5、Galaxy Watch5 Pro、Galaxy Watch6、Galaxy Watch6 Classic、Galaxy Watch FE、Galaxy Watch7、Galaxy Watch Ultra、Galaxy Watch8、Galaxy Watch8 Classic、Galaxy Watch9 和 Galaxy Watch Ultra2。Apple Watch Ultra、Apple Watch Ultra 2、Apple Watch Ultra 3 和 Galaxy Watch Ultra2 只需 Watch Dive 應用程式即可使用；其他所有支援的手錶需搭配 Watch Dive 感測器外殼與應用程式使用。",
    q7: "它如何運作？",
    a7: "Watch Dive 外殼內建壓力與水溫感測器，並透過 Bluetooth 將讀數傳送到您的智慧手錶。",
    q8: "電池可以用多久？可以更換嗎？",
...
const ja: FrozenLandingMessages = {
  ...
  inbox: {
    // 確認メールの件名とボタンは英語で送信されるため、引用部分は原文のまま。
    title: "あと一歩 — メールを確認してください 📬",
    note: "件名「Confirm your Watch Dive waitlist email」のメールを探して Confirm my email を押してください。1 分以内に届かない場合は迷惑メールやプロモーションのフォルダーを確認してください。リンクの有効期限は 24 時間で、このページは自動的に更新されます。",
    noteSubject: "「Confirm your Watch Dive waitlist email」",
    noteButton: "Confirm my email",
  ...
  compat: {
    ...
    housingLead: "深度センサーがない？ハウジングが持っています。",
    housingBody:
  ...
  faq: {
    ...
    q6: "私のスマートウォッチは対応していますか？",
    a6: "Watch DiveはすべてのApple Watchモデルと、以下のSamsungウォッチに対応しています：Galaxy Watch4、Galaxy Watch4 Classic、Galaxy Watch5、Galaxy Watch5 Pro、Galaxy Watch6、Galaxy Watch6 Classic、Galaxy Watch FE、Galaxy Watch7、Galaxy Watch Ultra、Galaxy Watch8、Galaxy Watch8 Classic、Galaxy Watch9、Galaxy Watch Ultra2。Apple Watch Ultra、Apple Watch Ultra 2、Apple Watch Ultra 3、Galaxy Watch Ultra2はWatch Diveアプリのみで使用できます。その他の対応ウォッチはWatch Diveセンサーハウジングとアプリを併用します。",
    q7: "どのように動作しますか？",
    a7: "Watch Diveハウジングには圧力センサーと水温センサーが搭載されており、その測定値をBluetooth経由でスマートウォッチに送信します。",
    q8: "バッテリーはどのくらい持ちますか？交換はできますか？",
    a8: "バッテリー保証は2年または1,000ダイブのいずれか早い方まで有効です。その後は、Watch Dive認定サービスセンターで有償にて消耗したバッテリーを交換できます。",
  },
  footer: {
    brand: "Watch Dive",
    legal:
...
const es: FrozenLandingMessages = {
  ...
  referral: {
    welcome: "Te invitó un amigo — ya estás en su lista. Confirma tu email para unirte con ellos.",
  ...
  inbox: {
    // El asunto y el botón del correo de confirmación se envían en inglés,
    // por eso las citas se mantienen en el original.
    title: "Un paso más — confirma tu email 📬",
    note: "Busca el asunto “Confirm your Watch Dive waitlist email” y pulsa Confirm my email. Revisa spam o promociones si no llega en un minuto. El enlace dura 24 horas y esta página se actualiza sola.",
    noteSubject: "“Confirm your Watch Dive waitlist email”",
    noteButton: "Confirm my email",
  ...
  safety: {
    ...
    point1Title: "Construido y certificado para 60 m",
  ...
  faq: {
    ...
    a2: "Watch Dive está certificado hasta 60 m, con una profundidad recreativa recomendada de 40 m.",
    ...
    q6: "¿Es compatible mi smartwatch?",
    a6: "Watch Dive es compatible con todos los modelos de Apple Watch y con los siguientes relojes Samsung: Galaxy Watch4, Galaxy Watch4 Classic, Galaxy Watch5, Galaxy Watch5 Pro, Galaxy Watch6, Galaxy Watch6 Classic, Galaxy Watch FE, Galaxy Watch7, Galaxy Watch Ultra, Galaxy Watch8, Galaxy Watch8 Classic, Galaxy Watch9 y Galaxy Watch Ultra2. El Apple Watch Ultra, el Apple Watch Ultra 2, el Apple Watch Ultra 3 y el Galaxy Watch Ultra2 pueden usarse solo con la app de Watch Dive; todos los demás relojes compatibles usan la carcasa con sensores de Watch Dive y la app.",
    q7: "¿Cómo funciona?",
    a7: "La carcasa de Watch Dive tiene sensores de presión y de temperatura del agua y envía sus lecturas a tu smartwatch por Bluetooth.",
    q8: "¿Cuánto dura la batería y se puede reemplazar?",
    a8: "La garantía de la batería dura dos años o 1,000 inmersiones, lo que ocurra primero. Después, un centro de servicio autorizado por Watch Dive puede reemplazar una batería desgastada por un costo adicional.",
  },
  footer: {
    brand: "Watch Dive",
    legal:
  ...
  verify: {
    ...
    errorBody: "Tu enlace no se ha gastado. Inténtalo de nuevo.",
    tryAgain: "Reintentar",
...
const fr: FrozenLandingMessages = {
  ...
  inbox: {
    // L'objet et le bouton de l'e-mail de confirmation sont envoyés en anglais,
    // les citations restent donc dans la langue d'origine.
    title: "Encore une étape — confirmez votre e-mail 📬",
    note: "Cherchez l'objet « Confirm your Watch Dive waitlist email » et appuyez sur Confirm my email. Vérifiez les spams ou l'onglet Promotions s'il n'arrive pas dans la minute. Le lien est valable 24 heures et cette page se met à jour toute seule.",
    noteSubject: "« Confirm your Watch Dive waitlist email »",
    noteButton: "Confirm my email",
  ...
  hero: {
    ...
    stat1Label: "60 m",
    stat1Desc: "Caisson certifié",
    stat2Label: "Scaphandre + Apnée",
  ...
  safety: {
    ...
    point1Title: "Conçu et certifié pour 60 m",
  ...
  faq: {
    ...
    a2: "Watch Dive est certifié à 60 m, avec une profondeur d'utilisation loisir recommandée de 40 m.",
    ...
    a6: "Watch Dive prend en charge tous les modèles d'Apple Watch ainsi que les montres Samsung suivantes : Galaxy Watch4, Galaxy Watch4 Classic, Galaxy Watch5, Galaxy Watch5 Pro, Galaxy Watch6, Galaxy Watch6 Classic, Galaxy Watch FE, Galaxy Watch7, Galaxy Watch Ultra, Galaxy Watch8, Galaxy Watch8 Classic, Galaxy Watch9 et Galaxy Watch Ultra2. L'Apple Watch Ultra, l'Apple Watch Ultra 2, l'Apple Watch Ultra 3 et la Galaxy Watch Ultra2 peuvent être utilisées avec la seule application Watch Dive ; toutes les autres montres prises en charge utilisent le boîtier à capteurs Watch Dive et l'application.",
    q7: "Comment ça fonctionne ?",
    a7: "Le boîtier Watch Dive intègre des capteurs de pression et de température de l'eau et transmet leurs mesures à votre montre connectée via Bluetooth.",
    q8: "Quelle est l'autonomie de la batterie et peut-elle être remplacée ?",
    a8: "La garantie de la batterie dure deux ans ou 1 000 plongées, selon la première éventualité. Ensuite, un centre de service agréé Watch Dive peut remplacer une batterie usée moyennant des frais.",
  },
  footer: {
    brand: "Watch Dive",
    legal:
  ...
  verify: {
    ...
    errorBody: "Votre lien n'a pas été consommé. Veuillez réessayer.",
    tryAgain: "Réessayer",
...
const de: FrozenLandingMessages = {
  ...
  inbox: {
    // Betreff und Button der Bestätigungsmail werden auf Englisch verschickt,
    // die Zitate bleiben deshalb im Original.
    title: "Noch ein Schritt — bestätige deine E-Mail 📬",
    note: "Suche nach dem Betreff „Confirm your Watch Dive waitlist email“ und drücke Confirm my email. Schau in Spam oder Werbung, falls sie nicht binnen einer Minute ankommt. Der Link gilt 24 Stunden, und diese Seite aktualisiert sich von selbst.",
    noteSubject: "„Confirm your Watch Dive waitlist email“",
    noteButton: "Confirm my email",
  ...
  form: {
    ...
    smsConsent:
      "Schickt mir eine SMS zum Watch-Dive-Start auf Kickstarter. Optional — deine E-Mail-Anmeldung funktioniert auch ohne.",
  ...
  hero: {
    ...
    stat1Label: "60 m",
    stat1Desc: "Zertifiziertes Gehäuse",
  ...
  functions: {
    ...
    h2: "Tiefe, Tauchzeit, Temperatur, Sicherheitsstopps, Aufstiegsgeschwindigkeit und NDL — in einem System.",
    ...
    item1Body:
      "Die sichere Aufstiegsgeschwindigkeit liegt bei 9–18 m/min. Watch Dive überwacht jeden Meter deines Aufstiegs und warnt dich, bevor du die Grenze überschreitest — ohne Tasten, ohne Menüs.",
  ...
  how: {
    ...
    step2Body:
      "Tiefe, Tauchzeit, Temperatur, Aufstiegsgeschwindigkeit und Sicherheitsstopps am Handgelenk.",
  ...
  safety: {
    ...
    point1Title: "Gebaut & zertifiziert für 60 m",
  ...
  faq: {
    ...
    a2: "Watch Dive ist bis 60 m zertifiziert, die empfohlene Einsatztiefe für Sporttauchen liegt bei 40 m.",
    ...
    a6: "Watch Dive unterstützt alle Apple Watch Modelle sowie die folgenden Samsung-Uhren: Galaxy Watch4, Galaxy Watch4 Classic, Galaxy Watch5, Galaxy Watch5 Pro, Galaxy Watch6, Galaxy Watch6 Classic, Galaxy Watch FE, Galaxy Watch7, Galaxy Watch Ultra, Galaxy Watch8, Galaxy Watch8 Classic, Galaxy Watch9 und Galaxy Watch Ultra2. Apple Watch Ultra, Apple Watch Ultra 2, Apple Watch Ultra 3 und Galaxy Watch Ultra2 können allein mit der Watch Dive-App verwendet werden; alle anderen unterstützten Uhren nutzen das Watch Dive-Sensorgehäuse und die App.",
    q7: "Wie funktioniert es?",
    a7: "Das Watch Dive-Gehäuse verfügt über Druck- und Wassertemperatursensoren und überträgt deren Messwerte per Bluetooth an deine Smartwatch.",
    q8: "Wie lange hält der Akku und kann er ausgetauscht werden?",
    a8: "Die Akku-Garantie gilt zwei Jahre oder 1.000 Tauchgänge, je nachdem, was zuerst eintritt. Danach kann ein von Watch Dive autorisiertes Servicecenter einen verschlissenen Akku gegen Gebühr austauschen.",
  },
  footer: {
    brand: "Watch Dive",
    legal:
  ...
  verify: {
    ...
    errorBody: "Dein Link ist noch nicht verbraucht. Bitte versuch es erneut.",
...
const ptBR: FrozenLandingMessages = {
  ...
  referral: {
    ...
    copied: "Copiado!",
    shareButton: "Mandar para seu dupla de mergulho",
    shareText:
  ...
  inbox: {
    // O assunto e o botão do e-mail de confirmação são enviados em inglês,
    // por isso as citações permanecem no original.
    title: "Falta um passo — confirme seu e-mail 📬",
    note: "Procure o assunto “Confirm your Watch Dive waitlist email” e aperte Confirm my email. Confira o spam ou a aba de promoções se não chegar em um minuto. O link vale por 24 horas e esta página se atualiza sozinha.",
    noteSubject: "“Confirm your Watch Dive waitlist email”",
    noteButton: "Confirm my email",
  ...
  hero: {
    ...
    stat1Label: "60 m",
    stat1Desc: "Caixa certificada",
    stat2Label: "Scuba + Livre",
  ...
  safety: {
    ...
    point1Title: "Construído e certificado para 60 m",
  ...
  faq: {
    ...
    a2: "O Watch Dive é certificado para 60 m, com profundidade recreativa recomendada de 40 m.",
    ...
    a6: "O Watch Dive é compatível com todos os modelos de Apple Watch e com os seguintes relógios Samsung: Galaxy Watch4, Galaxy Watch4 Classic, Galaxy Watch5, Galaxy Watch5 Pro, Galaxy Watch6, Galaxy Watch6 Classic, Galaxy Watch FE, Galaxy Watch7, Galaxy Watch Ultra, Galaxy Watch8, Galaxy Watch8 Classic, Galaxy Watch9 e Galaxy Watch Ultra2. O Apple Watch Ultra, o Apple Watch Ultra 2, o Apple Watch Ultra 3 e o Galaxy Watch Ultra2 podem ser usados apenas com o app Watch Dive; todos os outros relógios compatíveis usam a carcaça com sensores Watch Dive e o app.",
    q7: "Como funciona?",
    a7: "A carcaça Watch Dive possui sensores de pressão e de temperatura da água e envia as leituras para o seu smartwatch via Bluetooth.",
    q8: "Quanto tempo dura a bateria e ela pode ser substituída?",
    a8: "A garantia da bateria dura dois anos ou 1.000 mergulhos, o que ocorrer primeiro. Depois disso, um centro de serviço autorizado Watch Dive pode substituir uma bateria desgastada mediante taxa.",
  },
  footer: {
    brand: "Watch Dive",
    legal:
  ...
  verify: {
    ...
    errorBody: "Seu link não foi gasto. Tente novamente.",
